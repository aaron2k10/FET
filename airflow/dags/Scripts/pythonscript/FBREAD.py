...
try:
    ...
    try:
        ...
        zos_files.ds.download(target_dataset, f'/home/arunkua/airflow/dags/Scripts/Pyfiles/CGDEVPB.DCC.NEW2.txt')
        ...
        write_file('/home/arunkua/airflow/dags/Scripts/Pyfiles/CGDEVPB.DCC.NEW2.txt', '/home/arunkua/airflow/dags/Scripts/Pyfiles/CGDEVPB.DCC.NEW2.txt', copybook_structure)
    except Exception as e:
