...
def mainfunc():
    try:
        ...
        copybook = 'AWS.M5.CARDDEMO.CPY(PROCACCT)'
        ...
        try:
            ...
            zos_files.ds.download(target_dataset, f'/home/kalharis/airflow/dags/Scripts/Pyfiles/PROCACCT.txt')
            ...
            write_file('/home/kalharis/airflow/dags/Scripts/Pyfiles/PROCACCT.txt', '/home/kalharis/airflow/dags/Scripts/Pyfiles/PROCACCT.txt', copybook_structure)
        except Exception as e:
