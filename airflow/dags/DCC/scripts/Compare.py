...
for pyfilename in os.listdir(py_file_path):
    ...
    if mnffilename in os.listdir(mnf_file_path):
        ...
        # else:
        #     print(f"It is a empty dataframe : {pyfilename}")
        if diff_df.empty:
