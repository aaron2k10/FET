...
try:
    ...
    source_dataset = 'CGDEVPB.DCC.VBNEW2.OUT'
    target_dataset ='CGDEVPB.DCC.VBNEW4.OUT'
    copybook = 'DCC.FET.CPY(EMPCPY1)'
    ...
    try:
        ...
        #zos_files.ds.download(target_dataset, f'../Scripts/Pyfiles/CGDEVPB.DCC.VBNEW3.OUT.txt')
        ...
        #write_file('../Scripts/Pyfiles/CGDEVPB.DCC.VBNEW3.OUT.txt', '../Scripts/Pyfiles/CGDEVPB.DCC.VBNEW3.OUT.txt', copybook_structure)
    except Exception as e:
